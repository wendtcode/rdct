...
function isNumber(obj: any): obj is number {
  return (
    Object.prototype.toString.call(obj).slice(8, -1) === "Number" && !isNaN(obj)
  );
}
...
function isObject(obj: any): obj is Obj<ValidType> {
  return (
    ...
    Object.keys(obj).every((key) => isValidType(obj[key]))
  );
}
...
) => Obj<ValidType> | Array<ValidType> | string | null | undefined;
